...
На одной из бочек Кавус заметил оловянную вилку.

У неё было три зубца, но один уже был искривлен.
...
function takeFork() {
  if (!inventory.includes("оловянную вилка")) {
    inventory.push("оловянную вилка");
  }
...
— Кхе-хе-хе... передние...первые зубы всегда лишние...
